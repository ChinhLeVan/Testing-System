...
VALUES
                    ...
                    ('Các câu hỏi về PHP', 		'10',	'2', 	'2', 	'2021-08-05'),
                    ('Hỏi về C#', 				'9', 	'2', 	'3', 	'2020-12-16'),
                    ('Hỏi về Ruby', 			'6', 	'1', 	'4', 	'2019-07-06'),
                    ('Hỏi về Postman', 			'5', 	'1', 	'5', 	'2021-07-06'),
                    ('Hỏi về ADO.NET', 			'3', 	'2', 	'6', 	'2020-12-06'),
                    ('Hỏi về ASP.NET', 			'2', 	'1', 	'7', 	'2020-11-07'),
                    ('Hỏi về C++', 				'8', 	'1', 	'8', 	'2021-06-07'),
                    ('Hỏi về SQL', 				'4', 	'2', 	'9', 	'2020-04-07'),
                    ('Hỏi về Python', 			'7', 	'1', 	'10', 	'2021-07-07');
